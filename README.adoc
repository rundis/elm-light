...
- Either just invoke the command: "Editor: Toggle comment line(s) block aware"
- or even better add something like this to your ueer.keymap;

[source,clojure]
----
  [:editor "cmd-shift-," :toggle-comment-selection-block-aware] ; modify keybinding to your liking !
----
...
== History
* 0.1.2 UI for managing your project packages
